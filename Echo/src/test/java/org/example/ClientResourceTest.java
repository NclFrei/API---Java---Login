...
public class ClientResourceTest {
    ...
    @Test
    public void testAdicionarSemSucesso() throws SQLException {
        Cliente cliente = new Cliente(); // Inicialize o cliente conforme necessário

        // Simulando uma exceção SQL ao tentar adicionar o cliente
        doThrow(new SQLException("Erro ao adicionar cliente")).when(clienteServico).adicionar(cliente);
      ...
      //  assertEquals(Response.Status.INTERNAL_SERVER_ERROR.getStatusCode(), response.getStatus());
        ...
        assertEquals("Erro ao adicionar cliente", response.getEntity());
    }
    @Test
